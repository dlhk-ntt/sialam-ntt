            ...
            <div class="modal-content">
                ...
                <div class="modal-body" id="modal-container" name="modal-container" style="text-align: center">
                    ...
                    <table id="tbl-legendps" class="table table-striped table-bordered">
                        ...
                        <tr><td colspan="2">Skema PS</td></tr>
                        ...
                        <tr><td colspan="2">Fungsi Kawasan Hutan</td></tr>
                        <tr><td>HL</td><td>Hutan Lindung</td></tr>
                        <tr><td>HP</td><td>Hutan Produksi</td></tr>
                        <tr><td>HPT</td><td>Hutan Produksi Terbatas</td></tr>
                    </table>
                </div>
            </div>
        </div>
...
setTimeout(() => {
            ...
            L.geoJson(region, {
                ...
                onEachFeature: function(feature, layer) {
                    ...
                    for (var key in feature.properties) {
                        ...
                        if (key == 'skema_ps' && (feature.properties[key] != '-' && feature.properties[key] != 'Tidak direkomendasi PS')) {
                            table += '<tr><td colspan="2" style="text-align: right"><a class="text-white btn btn-primary btn-sm" href="#" onclick="openLandAccessApp(\'' + btoa(feature.properties['idd']) + '\')">Pilih dan Proses</a></td></tr>';
                        }
                    }
                    table += '</table>';
    ...
    @else
        ...
        region = function() {
            var data;
            $.ajax({ url: APP_URL + '/shpfile/load/{{ $map->id }}', type: 'GET', dataType: 'json', async: false, success: function(data) { ret = data; } });
            return ret;
        }();
        lstFieldsRegional = '{{ $map->selected_fields }}';
        if (region.features) {
            L.geoJson(region, {
                ...
                onEachFeature: function(feature, layer) {
                    ...
                    for (var key in feature.properties) {
                        ...
                        if (key == 'skema_ps' && (feature.properties[key] != '-' && feature.properties[key] != 'Tidak direkomendasi PS')) {
                            btn = '<tr><td colspan="2" style="text-align: right"><a class="text-white btn btn-primary btn-sm" href="#" onclick="openLandAccessApp(\'' + btoa(feature.properties['idd']) + '\')">Pilih dan Proses</a></td></tr>';
                        }
                    }
                    table += btn + '</table>';
                    layer.bindPopup(table);
